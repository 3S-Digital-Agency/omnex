...
export const services: ServiceDefinition[] = [
  {
    ...
    en: {
      ...
      caps: ['Domain search & registration', 'DNS records, templates & rollback', 'Renewals & auto-renew', 'Privacy, locking & nameservers'],
    ...
    fr: {
      ...
      caps: ['Recherche et enregistrement de domaines', 'Enregistrements DNS, modèles et restauration', 'Renouvellements et renouvellement auto', 'Confidentialité, verrouillage et serveurs de noms'],
  ...
  },
  {
    ...
    en: {
      ...
      caps: ['Git deployment', 'Staging & production', 'Environment variables (encrypted)', 'SSL, logs & rollback'],
    ...
    fr: {
      ...
      caps: ['Déploiement Git', 'Staging et production', 'Variables d’environnement (chiffrées)', 'SSL, journaux et restauration'],
